package net.aerokit.tutorialmod.block.entity;

import net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerFactory;
import net.aerokit.tutorialmod.Item.ModItems;
import net.aerokit.tutorialmod.recipe.GemPolishingRecipe;
import net.aerokit.tutorialmod.screen.GempolishingScreenHandler;
...
public class GemPolishingStationBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    private void craftItem() {
        ...
        this.setStack(OUTPUT_SLOT, new ItemStack(recipe.get().value().getResult(null).getItem(), getStack(OUTPUT_SLOT).getCount()
                + recipe.get().value().getResult(null).getCount()));
    }
