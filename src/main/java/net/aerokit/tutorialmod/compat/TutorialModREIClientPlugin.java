package net.aerokit.tutorialmod.compat;
...
public class TutorialModREIClientPlugin implements REIClientPlugin {
    ...
    public void registerScreens(ScreenRegistry registry) {
        registry.registerClickArea(screen -> new Rectangle(75, 30, 20, 30), GemPolishingScreen.class, GemPolishingCategory.GEM_POLISHING);
    }
}
