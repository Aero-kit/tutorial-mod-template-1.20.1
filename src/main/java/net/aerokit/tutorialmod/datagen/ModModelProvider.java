...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.RAW_CITRINE_BLOCK);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.END_STONE_CITRINE_ORE);
        ...
        blockStateModelGenerator.registerSimpleState(ModBlocks.GEM_POLISHIN_STATION);
