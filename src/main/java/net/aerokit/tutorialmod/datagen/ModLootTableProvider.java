...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.RAW_CITRINE_BLOCK);
        ...
        addDrop(ModBlocks.CITRINE_ORE, copperLikeOreDrops(ModBlocks.CITRINE_ORE, ModItems.RAW_CITRINE));
        addDrop(ModBlocks.DEEPSLATE_CITRINE_ORE, copperLikeOreDrops(ModBlocks.DEEPSLATE_CITRINE_ORE, ModItems.RAW_CITRINE));
        addDrop(ModBlocks.NETHER_CITRINE_ORE, copperLikeOreDrops(ModBlocks.NETHER_CITRINE_ORE, ModItems.RAW_CITRINE));
        addDrop(ModBlocks.END_STONE_CITRINE_ORE, copperLikeOreDrops(ModBlocks.END_STONE_CITRINE_ORE, ModItems.RAW_CITRINE));
